...
enum class RegisterError : uint8_t
{
    ...
    TARGET_UNREACHABLE, TIMEOUT_UNKNOWN,   // TIMEOUT_UNKNOWN = outcome unknown, rollback fired
...
struct RegistrationIdentity
{
    ...
    {
        return sourceCsmInstanceId == o.sourceCsmInstanceId &&
...
enum class RegistrationPhase : uint8_t { PENDING, REGISTERED, RETRY_WAIT, REMOVING };
